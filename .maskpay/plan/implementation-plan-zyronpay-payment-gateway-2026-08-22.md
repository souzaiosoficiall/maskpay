...
> [!IMPORTANT]
> The request involves building a full payment gateway (API, webhooks, financial ledger). This requires careful handling of security and financial data. I will use **MaskPay Cloud** for persistent storage and authentication.
...
- **Authentication**: Create `/auth` routes for Login and Signup using MaskPay Cloud.
...
- **Persistence**: MaskPay Cloud (PostgreSQL).
- **Security**: 
